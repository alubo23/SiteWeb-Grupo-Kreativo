...
//Accordion
(function(){
    const titleQuestions = [...document.querySelectorAll('.trainee__title')];
    ...
    titleQuestions.forEach(question =>{
        question.addEventListener('click', ()=>{
            ...
            addPadding.classList.toggle('trainee__padding--add');
            question.children[0].classList.toggle('trainee__arrow--rotate');
